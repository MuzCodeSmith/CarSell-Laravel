                ...
                <div class="car-images-and-description">
                    ...
                    <div class="card car-detailed-description">
                        ...
                        <ul class="car-specifications">
                            <x-car-specification :feature="$car->features->abs">
                                Abs
                            </x-car-specification>
                            ...
                            <x-car-specification :feature="$car->features->power_door_locks	">
                            Power Door Locks	
                            </x-car-specification>
                            <x-car-specification :feature="$car->features->bluetooth_connectivity	">
                            Bluetooth Connectivity	
                            </x-car-specification>
                            <x-car-specification :feature="$car->features->cruise_control">
                            Cruise Control	
                            </x-car-specification>
                            <x-car-specification :feature="$car->features->cruise_control">
                            Cruise Control	
                            </x-car-specification>
                            <x-car-specification :feature="$car->features->heated_seats">
                            Heated Seats	
                            </x-car-specification>
                            <x-car-specification :feature="$car->features->gps_navigation">
                            GPS Navigation	
                            </x-car-specification>
                            <x-car-specification :feature="$car->features->remote_start">
                            Remote Start	
                            </x-car-specification>
                            <x-car-specification :feature="$car->features->leather_seats">
                            Leather Seats	
                            </x-car-specification>
                            <x-car-specification :feature="$car->features->rear_parking_sensors">
                            Rear Parking Sensors
                            </x-car-specification>
                            <x-car-specification :feature="$car->features->climate_control">
                            Climate Control	
                            </x-car-specification>
                        </ul>
                    </div>
